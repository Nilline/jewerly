(() => {
    ...
    function script_bodyUnlock(delay) {
        if (script_bodyLockStatus) {
            ...
            setTimeout((() => {
                qe("body").style.removeProperty("padding-right");
    ...
    function script_bodyLock(delay) {
        if (script_bodyLockStatus) {
            qe("body").style.paddingRight = window.innerWidth - qe(".wrapper").offsetWidth + "px";
    ...
    class Popup {
        ...
        open(selectorValue) {
            if (script_bodyLockStatus) {
                ...
                if (this.targetOpen.element) {
                    ...
                    if (!this._reopen) !this.bodyLock ? script_bodyLock() : null; else this._reopen = false;
        ...
        close(selectorValue) {
            ...
            if (!this.isOpen || !script_bodyLockStatus) return;
            ...
            if (!this._reopen) {
                ...
                !this.bodyLock ? script_bodyUnlock() : null;
                this.isOpen = false;
            }
            this._removeHash();
